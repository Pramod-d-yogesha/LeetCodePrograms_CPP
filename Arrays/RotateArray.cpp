...
Each shift takes O(N), leading to an O(N*K) time complexity.
...
=================================================================
Approach 3: In-Place Rotation (O(N) Time, O(1) Space)----->Optimal
------------------------------------------------------------------
Using three reversals, we can rotate the array without extra space:
